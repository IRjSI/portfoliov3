...
const Projects = () => {
  return (
    ...
    >
      ...
      <ProjectCard link="https://rjsv2.vercel.app" img="/Screenshot 2025-04-19 111354.png" name="Portfolio v2" description="A modern and sleek portfolio" />
      <ProjectCard link="https://book-trakker.vercel.app" img="/Screenshot 2025-04-23 161807.png" name="Book Tracker" description="A book tracker web-app" />
      <ProjectCard link="/" img="/Screenshot 2025-01-17 161510.png" name="Movie Finder" description="A website to find about your favourite movies" />
